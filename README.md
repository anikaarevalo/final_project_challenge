...
- My app could also benefit from an automated scraping functionality that can collect online customer feedback in real time and a secondary analytics dashboard that can tally results on a periodic basis (according to the preference set by the end user).
